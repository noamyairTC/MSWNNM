...
For reproducing paper experiments use the 'ReproduceExperiments.m' file and follow the instruction in the documentation. You may also run this function as-is for a simple example.
...
# Some Visual Examples (from the paper)
...
<p align="center">
<img src="/Misc/ResultsExamples/comparison_zoom.gif" width="800">
</p>
